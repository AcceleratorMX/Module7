...
class GooWordStat {
    ...
    public String toString() {
        if (freq < 1000){return "Word is [" + word + "], search freq is " + "LOW";}
        else if (freq >= 1000 && freq < 100000) {return "Word is [" + word + "], search freq is " + "MEDIUM";}
        else if (freq >= 100000 && freq < 10000000) {return "Word is [" + word + "], search freq is " + "HIGH";}
